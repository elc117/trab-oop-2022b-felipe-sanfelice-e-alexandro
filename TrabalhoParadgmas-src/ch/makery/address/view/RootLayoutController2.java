 ...
 * @author alejb
 */
public class RootLayoutController2 {
    ...
    private void handleOpen() {
        ...
        if (file != null) {
            mainApp.loadPersonDataFromFile(file, "person2");
        }
    }
    ...
    private void handleSave() {
        ...
        if (personFile != null) {
            mainApp.savePersonDataToFile(personFile, "person2");
        } else {
            handleSaveAs();
        }
    }
    ...
    private void handleSaveAs() {
        ...
        if (file != null) {
            ...
            mainApp.savePersonDataToFile(file, "person2");
        }
    }
